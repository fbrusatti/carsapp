...
DROP TABLE IF EXISTS adresss; -- Direccion
...
DROP TABLE IF EXISTS user_adresss; -- tabla que contiene la informacion para referenciar a usuario y direccion
CREATE TABLE user_adresss(
